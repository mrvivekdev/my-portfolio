...
const Skills:React.FC = () => {
    ...
    return(
        <>
            <div id="ScrollAll" className="h-full w-full bg-orange-200 flex flex-col justify-center lg:justify-evenly items-center lg:flex-row overflow-x-hidden overflow-y-hidden">
                <div id="ScrollTraggerSkills" className="flex flex-col justify-center items-center p-4 lg:h-3/4 lg:w-1/4 lg:mt-48 lg:mb-48">
                    <h1 className="text-black text-5xl font-bold mt-10">Frontend</h1>
                    <span className="text-black font-medium pl-2 pt-5 lg:text-lg text-center">
                ...
                <div id="ScrollTraggerSkills" className="flex flex-col justify-center items-center p-4 lg:h-3/4 lg:w-1/4 ">
                ...
                <div id="ScrollTraggerSkills" className="flex flex-col justify-center items-center p-4 lg:h-3/4 lg:w-1/4 mb-10">
